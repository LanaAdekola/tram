...
function App() {
  return (
    <div className="App">
<main className="flex min-h-screen flex-col py-4 lg:py-10 px-2 lg:px-8 custom-gradient">
        <div className="w-full mb-10 flex justify-between items-center">
          <div className="">
          <img src={logo} alt="main" className="h-10 ml-4 md:h-14 lg:h-20 w-auto" />
          </div>
        ...
        <div class="w-full text-white pt-12 p-4">
          <div class="grid gap-14 md:grid-cols-3 md:gap-5">
            <div class="rounded-xl border border-[#F1CB06] bg-transparent p-6 text-center shadow-xl">
              ...
              <h1 class="mb-3 text-xl font-medium lg:px-14">Pro Experience</h1>
              <p class="px-4 ">Trained already as a professional, bringing years of industry knowledge to every interaction.</p>
            </div>
            <div data-aos-delay="150" class="rounded-xl border border-[#F1CB06] bg-transparent p-6 text-center shadow-xl">
              ...
              <h1 class="mb-3 text-xl font-medium lg:px-14">Adaptive AI</h1>
              <p class="px-4 ">Learns and personalizes interactions dynamically, continuously evolving to meet individual customer needs and preferences.</p>
            </div>
            <div data-aos-delay="300" class="rounded-xl border border-[#F1CB06] bg-transparent p-6 text-center shadow-xl">
              ...
              <h1 class="mb-3 text-xl font-medium lg:px-14">Autonomous Service</h1>
              <p class="px-4 ">Seamlessly plugs into your systems and performs needed tasks autonomously.</p>
            </div>
          </div>
        </div>
      </main>
